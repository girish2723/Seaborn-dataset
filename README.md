...
Quick start
- What you’ll get: clean CSV files ready for analysis and visualization. Each dataset comes with a short description, a suggested set of columns for plotting, and a quick guide on typical seaborn visualizations.
...
Repository structure and how to contribute
- Top-level items:
  - datasets/ — CSV files for quick loading and plotting
  - notebooks/ — example Jupyter notebooks for visualization workflows
  - tools/ — small helper scripts for loading, cleaning, and plotting
...
- v1.0.0 — Initial release: a core set of CSV datasets plus basic notebooks for seaborn demonstrations.
- v1.1.0 — Added additional datasets focused on climate and education. Updated notebooks with new plotting patterns.
- v1.2.0 — Improved documentation, added data provenance notes, and expanded licensing statements.
- v1.3.0 — Introduced energy and health metrics datasets, plus new examples for multi-plot storytelling.
- v1.4.0 — Performance improvements in data loading and improved default seaborn settings for visuals.
